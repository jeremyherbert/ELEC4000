...
# 69 "/home/tinyos/local/src/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t /*RssiBaseAppC.ReporMatrixtMsgSender.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
/*RssiBaseAppC.ReporMatrixtMsgSender.AMQueueEntryP*/AMQueueEntryP__1__AMSend__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 89 "/home/tinyos/local/src/tinyos-2.x/tos/interfaces/Send.nc"
static void /*RssiBaseAppC.ReporMatrixtMsgSender.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(
#line 85
message_t * msg, 
...
# 92 "/home/tinyos/local/src/tinyos-2.x/tos/interfaces/SplitControl.nc"
static void RssiBaseC__SerialControl__startDone(error_t error);
#line 117
static void RssiBaseC__SerialControl__stopDone(error_t error);
#line 92
...
RssiBaseC__ReportMsgReceive__receive(
#line 60
message_t * msg, 
void * payload, 
...
uint8_t len);
# 99 "/home/tinyos/local/src/tinyos-2.x/tos/interfaces/AMSend.nc"
static void RssiBaseC__ReportMatrixMsgSend__sendDone(
#line 92
message_t * msg, 
...
#line 85
#line 79
typedef enum CC2420ControlP____nesc_unnamed4316 {
...
enum /*Counter32khz32C.Transform*/TransformCounterC__0____nesc_unnamed4347 {
...
enum /*AlarmMultiplexC.Alarm.Alarm32khz32C.Transform*/TransformAlarmC__0____nesc_unnamed4348 {
...
# 39 "/home/tinyos/local/src/tinyos-2.x/tos/system/FcfsResourceQueueC.nc"
enum /*Msp430UsartShare0P.ArbiterC.Queue*/FcfsResourceQueueC__2____nesc_unnamed4355 {
#line 39
...
# 75 "/home/tinyos/local/src/tinyos-2.x/tos/system/ArbiterP.nc"
enum /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1____nesc_unnamed4356 {
#line 75
...
enum /*CounterMilli32C.Transform*/TransformCounterC__1____nesc_unnamed4365 {
...
enum /*HilTimerMilliC.AlarmMilli32C.Transform*/TransformAlarmC__1____nesc_unnamed4366 {
...
message_t *msg);
# 99 "/home/tinyos/local/src/tinyos-2.x/tos/interfaces/AMSend.nc"
static void /*RssiBaseAppC.ReporMatrixtMsgSender.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/home/tinyos/local/src/tinyos-2.x/tos/interfaces/Send.nc"
static error_t /*RssiBaseAppC.ReporMatrixtMsgSender.AMQueueEntryP*/AMQueueEntryP__1__Send__send(
#line 56
message_t * msg, 
...
/*RssiBaseAppC.ReporMatrixtMsgSender.AMQueueEntryP*/AMQueueEntryP__1__Send__getPayload(
#line 111
message_t * msg, 
...
uint8_t len);
# 92 "/home/tinyos/local/src/tinyos-2.x/tos/interfaces/AMPacket.nc"
static void /*RssiBaseAppC.ReporMatrixtMsgSender.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*RssiBaseAppC.ReporMatrixtMsgSender.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(
#line 147
message_t * amsg, 
...
am_id_t t);
# 45 "/home/tinyos/local/src/tinyos-2.x/tos/system/AMQueueEntryP.nc"
static inline error_t /*RssiBaseAppC.ReporMatrixtMsgSender.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*RssiBaseAppC.ReporMatrixtMsgSender.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(message_t *m, error_t err);
...
static inline void */*RssiBaseAppC.ReporMatrixtMsgSender.AMQueueEntryP*/AMQueueEntryP__1__AMSend__getPayload(message_t *m, uint8_t len);
# 53 "/home/tinyos/local/src/tinyos-2.x/tos/lib/timer/Timer.nc"
static void RssiBaseC__SendTimer__startPeriodic(uint32_t dt);
# 83 "/home/tinyos/local/src/tinyos-2.x/tos/interfaces/SplitControl.nc"
static error_t RssiBaseC__SerialControl__start(void );
#line 83
static error_t RssiBaseC__RadioControl__start(void );
# 69 "/home/tinyos/local/src/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t RssiBaseC__ReportMatrixMsgSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
RssiBaseC__ReportMatrixMsgSend__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 56 "/home/tinyos/local/src/tinyos-2.x/tos/interfaces/Leds.nc"
static void RssiBaseC__Leds__led0Toggle(void );
#line 72
static void RssiBaseC__Leds__led1Toggle(void );
# 13 "RssiBaseC.nc"
message_t RssiBaseC__report_msg;
ReportMatrixMsg *RssiBaseC__report_data;

static inline void RssiBaseC__initReport(void );
...
static inline void RssiBaseC__SerialControl__startDone(error_t result);
static inline void RssiBaseC__SerialControl__stopDone(error_t result);

static inline message_t *RssiBaseC__ReportMsgReceive__receive(message_t *msg, void *payload, uint8_t len);
#line 57
static inline void RssiBaseC__SendTimer__fired(void );



static inline void RssiBaseC__ReportMatrixMsgSend__sendDone(message_t *m, error_t error);
...
# 92 "/home/tinyos/local/src/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void CC2420TinyosNetworkP__Resource__granted(uint8_t arg_0x411a3628){
#line 92
  switch (arg_0x411a3628) {
#line 92
...
#line 92
    default:
#line 92
      CC2420TinyosNetworkP__Resource__default__granted(arg_0x411a3628);
#line 92
      break;
#line 92
    }
...
# 64 "/home/tinyos/local/src/tinyos-2.x/tos/interfaces/Send.nc"
inline static error_t /*RssiBaseAppC.ReporMatrixtMsgSender.AMQueueEntryP*/AMQueueEntryP__1__Send__send(message_t * msg, uint8_t len){
#line 64
  unsigned char result;
#line 64

#line 64
  result = /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__send(1U, msg, len);
#line 64
...
inline static void /*RssiBaseAppC.ReporMatrixtMsgSender.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(message_t * amsg, am_id_t t){
#line 151
...
# 92 "/home/tinyos/local/src/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static void /*RssiBaseAppC.ReporMatrixtMsgSender.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 92
...
#line 47
{
  /*RssiBaseAppC.ReporMatrixtMsgSender.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(msg, dest);
  /*RssiBaseAppC.ReporMatrixtMsgSender.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(msg, 12);
  return /*RssiBaseAppC.ReporMatrixtMsgSender.AMQueueEntryP*/AMQueueEntryP__1__Send__send(msg, len);
}

# 69 "/home/tinyos/local/src/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t RssiBaseC__ReportMatrixMsgSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char result;
#line 69

#line 69
  result = /*RssiBaseAppC.ReporMatrixtMsgSender.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(addr, msg, len);
#line 69
...
# 56 "/home/tinyos/local/src/tinyos-2.x/tos/interfaces/Leds.nc"
inline static void RssiBaseC__Leds__led0Toggle(void ){
#line 56
...
#line 57
{
  RssiBaseC__Leds__led0Toggle();
  RssiBaseC__ReportMatrixMsgSend__send(AM_BROADCAST_ADDR, &RssiBaseC__report_msg, sizeof(ReportMatrixMsg ));
}
...
#line 38
{
  ...
  printf("report from %d: ", __nesc_ntoh_uint8(rdata->id.data));

  for (i = 0; i < NUM_NODES; i++) {
      __nesc_hton_int8(RssiBaseC__report_data->rssi[__nesc_ntoh_uint8(rdata->id.data)][i].data, __nesc_ntoh_int8(rdata->rssi[i].data));

      printf(" %d%c", __nesc_ntoh_int8(rdata->rssi[i].data), i == NUM_NODES - 1 ? '\n' : ',');
    }
...
#line 67
    case 11:
#line 67
      result = RssiBaseC__ReportMsgReceive__receive(msg, payload, len);
#line 67
      break;
#line 67
    default:
...
# 99 "/home/tinyos/local/src/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void /*RssiBaseAppC.ReporMatrixtMsgSender.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(message_t * msg, error_t error){
#line 99
  RssiBaseC__ReportMatrixMsgSend__sendDone(msg, error);
#line 99
}
#line 99
# 57 "/home/tinyos/local/src/tinyos-2.x/tos/system/AMQueueEntryP.nc"
...
#line 57
{
  /*RssiBaseAppC.ReporMatrixtMsgSender.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(m, err);
}
...
#line 89
    case 1U:
#line 89
      /*RssiBaseAppC.ReporMatrixtMsgSender.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(msg, error);
#line 89
      break;
#line 89
    default:
...
#line 117
  RssiBaseC__SerialControl__stopDone(error);
#line 117
}
#line 117
...
#line 18
  for (i = 0; i < NUM_NODES; i++) 
    for (j = 0; j < NUM_NODES; j++) 
      __nesc_hton_int8(RssiBaseC__report_data->rssi[i][j].data, UNDEF_RSSI);
}

# 86 "/home/tinyos/local/src/tinyos-2.x/tos/lib/serial/SerialActiveMessageP.nc"
static inline void */*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__getPayload(am_id_t id, message_t *m, uint8_t len)
#line 86
{
...
inline static void * /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__getPayload(am_id_t arg_0x40bf3490, message_t * msg, uint8_t len){
#line 124
  void *result;
#line 124

#line 124
  result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__getPayload(arg_0x40bf3490, msg, len);
#line 124
...
inline static void * /*RssiBaseAppC.ReporMatrixtMsgSender.AMQueueEntryP*/AMQueueEntryP__1__Send__getPayload(message_t * msg, uint8_t len){
#line 114
  void *result;
#line 114

#line 114
  result = /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__getPayload(1U, msg, len);
#line 114
...
#line 65
{
  return /*RssiBaseAppC.ReporMatrixtMsgSender.AMQueueEntryP*/AMQueueEntryP__1__Send__getPayload(m, len);
}

# 124 "/home/tinyos/local/src/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void * RssiBaseC__ReportMatrixMsgSend__getPayload(message_t * msg, uint8_t len){
#line 124
  void *result;
#line 124

#line 124
  result = /*RssiBaseAppC.ReporMatrixtMsgSender.AMQueueEntryP*/AMQueueEntryP__1__AMSend__getPayload(msg, len);
#line 124
...
# 83 "/home/tinyos/local/src/tinyos-2.x/tos/interfaces/SplitControl.nc"
inline static error_t RssiBaseC__SerialControl__start(void ){
#line 83
  unsigned char result;
#line 83
...
#line 23
{
  ...
  RssiBaseC__SerialControl__start();
  RssiBaseC__report_data = RssiBaseC__ReportMatrixMsgSend__getPayload(&RssiBaseC__report_msg, sizeof(ReportMatrixMsg ));
  RssiBaseC__initReport();
}
...
#line 92
  RssiBaseC__SerialControl__startDone(error);
#line 92
}
#line 92
...
#line 99
    CC2420ActiveMessageP__AMSend__default__sendDone(arg_0x411df3f8, msg, error);
#line 99
}
#line 99
...
# 53 "/home/tinyos/local/src/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void RssiBaseC__SendTimer__startPeriodic(uint32_t dt){
#line 53
...
#line 30
{
  RssiBaseC__SendTimer__startPeriodic(SEND_REPORT_MS);
}
